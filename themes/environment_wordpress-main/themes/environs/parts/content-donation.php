                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="<?php echo get_theme_file_uri('img/donation-1.jp');?>g" class="img-fluid w-100" alt="Image">
                    ...
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="<?php echo get_theme_file_uri('img/service-2.jpg');?>" class="img-fluid w-100" alt="Image">
                            <div class="donation-content d-flex flex-column">
                    ...
                    <div class="col-lg-4">
                        <div class="donation-item">
                            <img src="<?php echo get_theme_file_uri('img/donation-3.jp');?>g" class="img-fluid w-100" alt="Image">
                            <div class="donation-content d-flex flex-column">
